...
const ASSETS = [
  ...
  "./js/views/dashboard.js", "./js/views/budget.js", "./js/views/categories.js", "./js/views/settings.js", "./js/views/vehicles.js", "./js/views/debts.js",
